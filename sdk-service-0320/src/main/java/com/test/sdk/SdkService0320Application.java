...
@MapperScan("com.test.sdk.dao")//Mybatis的DAO所在包
@EnableCaching
@EnableDubbo//开启dubbo
public class SdkService0320Application {

	public static void main(String[] args) {
		SpringApplication.run(SdkService0320Application.class, args);
	}

	@Autowired
	private DataSource dataSource;

	private String transactionExecution = "execution(* com.test.sdk.service..*(..))";
